...
const Q = {
  arthur:[
    {q:'What is 347 + 258?',a:'605',c:["595","605","615","505"],d:'easy'},
    {q:'What is 800 - 463?',a:'337',c:["347","337","437","363"],d:'easy'},
    {q:'What is 6 x 7?',a:'42',c:["36","48","42","54"],d:'easy'},
    {q:'What is 56 / 8?',a:'7',c:["6","7","8","9"],d:'easy'},
    {q:'3 out of 4 equal parts shaded. What fraction?',a:'3/4',c:["1/4","3/4","4/3","1/3"],d:'easy'},
    {q:'Which number is even?',a:'64',c:["37","51","43","64"],d:'easy'},
    {q:'Perimeter of rectangle: length 5 cm, width 3 cm?',a:'16 cm',c:["8 cm","15 cm","16 cm","10 cm"],d:'easy'},
    {q:'Round 472 to the nearest hundred.',a:'500',c:["400","500","470","480"],d:'easy'},
    {q:'Which fraction is equivalent to 1/2?',a:'4/8',c:["2/3","3/4","4/8","2/5"],d:'easy'},
    {q:'Area of rectangle: length 4 cm, width 6 cm?',a:'24 sq cm',c:["20 sq cm","24 sq cm","10 sq cm","22 sq cm"],d:'easy'},
    {q:'What is 9 x 8?',a:'72',c:["63","81","72","64"],d:'easy'},
    {q:'24 students in 4 equal groups. How many per group?',a:'6',c:["5","6","7","8"],d:'easy'},
    {q:'What is 1,000 - 1?',a:'999',c:["999","1,001","99","990"],d:'easy'},
    {q:'Which number is odd?',a:'77',c:["100","48","77","32"],d:'easy'},
    {q:'What is 5 x 0?',a:'0',c:["5","1","50","0"],d:'easy'},
    {q:'How many minutes are in 1 hour?',a:'60',c:["30","100","60","24"],d:'easy'},
    {q:'What is 3/8 + 2/8?',a:'5/8',c:["5/16","6/8","5/8","1/8"],d:'medium'},
    {q:'How do you write four hundred fifty-two?',a:'452',c:["4,052","452","4,520","425"],d:'medium'},
    {q:'Value of the digit 7 in 573?',a:'70',c:["7","70","700","7,000"],d:'medium'},
    {q:'15 apples, eat 3 each day. Days until empty?',a:'5',c:["3","4","5","6"],d:'medium'},
    {q:'What is 4 x 4 x 4?',a:'64',c:["12","16","64","48"],d:'medium'},
    {q:'Shape with 4 equal sides and 4 right angles?',a:'Square',c:["Rectangle","Triangle","Square","Pentagon"],d:'medium'},
    {q:'Which is greater: 2/4 or 1/4?',a:'2/4',c:["1/4","2/4","They are equal","Cannot tell"],d:'medium'},
    {q:'What is 700 + 80 + 3?',a:'783',c:["783","7,803","738","780"],d:'medium'},
    {q:'How many sides does a hexagon have?',a:'6',c:["5","7","8","6"],d:'medium'},
    {q:'Hour hand at 3, minute hand at 12. What time?',a:'3:00',c:["12:03","3:12","3:00","12:15"],d:'medium'},
    {q:'Which unit measures weight of a watermelon?',a:'Pounds',c:["Inches","Cups","Pounds","Seconds"],d:'medium'},
    {q:'What is 7 x 3?',a:'21',c:["10","21","24","28"],d:'medium'},
    {q:'Have $1.00, spend $0.35. How much left?',a:'$0.65',c:["$0.65","$0.75","$0.55","$0.60"],d:'medium'},
    {q:'Which fact belongs with 4 x 7 = 28?',a:'28 / 4 = 7',c:["28 / 8 = 4","28 / 4 = 7","28 + 4 = 32","7 + 4 = 11"],d:'medium'},
    {q:'Round 482 to the nearest ten.',a:'480',c:["480","490","400","500"],d:'medium'},
    {q:'Which fraction is the smallest?',a:'1/4',c:["3/4","1/2","1/4","2/3"],d:'medium'},
    {q:'Missing number: 6 x ___ = 54',a:'9',c:["7","8","9","6"],d:'medium'},
    {q:'Perimeter 18 cm, width 3 cm. What is the length?',a:'6 cm',c:["6 cm","5 cm","9 cm","12 cm"],d:'hard'},
    {q:'What is 200 x 4?',a:'800',c:["600","800","400","1,000"],d:'hard'},
    {q:'How many days are in 2 weeks?',a:'14',c:["10","12","14","16"],d:'hard'},
    {q:'Which shows the commutative property?',a:'3 x 4 = 4 x 3',c:["3 x 4 = 4 x 3","3 + 0 = 3","(2x3)x4 = 2x(3x4)","3 x 1 = 3"],d:'hard'},
    {q:'Each star = 5 students. 4 stars = how many students?',a:'20',c:["9","20","45","15"],d:'hard'},
    {q:'What is 1/3 of 12?',a:'4',c:["3","4","6","9"],d:'hard'},
    {q:'Which is NOT a quadrilateral?',a:'Triangle',c:["Square","Rectangle","Triangle","Parallelogram"],d:'hard'},
    {q:'Next number: 5, 10, 15, 20, ___?',a:'25',c:["24","25","30","22"],d:'hard'},
    {q:'Pizza cut in 8, eat 3. Fraction left?',a:'5/8',c:["3/8","5/8","5/5","3/5"],d:'hard'},
    {q:'What is 456 + 344?',a:'800',c:["790","800","780","810"],d:'hard'},
    {q:'Which unit measures liquid volume?',a:'Liters',c:["Pounds","Inches","Liters","Degrees"],d:'hard'},
    {q:'What is 8 x 8?',a:'64',c:["56","72","64","48"],d:'hard'},
    {q:'Where is 1/2 placed between 0 and 1?',a:'At the middle',c:["At the 1/4 mark","At the 3/4 mark","At the middle","At the end"],d:'hard'},
    {q:'36 stickers shared equally among 9 friends. Each gets?',a:'4',c:["3","4","5","6"],d:'hard'},
    {q:'What is 4,000 - 2,000?',a:'2,000',c:["1,000","2,000","6,000","3,000"],d:'hard'},
    {q:'Which solid figure has 6 faces?',a:'Cube',c:["Sphere","Cone","Cube","Cylinder"],d:'hard'},
    {q:'What is 3 x 9 + 1?',a:'28',c:["27","28","30","31"],d:'hard'},
    {q:'What does it mean when a story has a \'setting\'?',a:'Where and when the story takes place',c:["The main character","Where and when the story takes place","The problem in the story","How the story ends"],d:'easy'},
    {q:'Which word is a synonym for \'happy\'?',a:'Joyful',c:["Sad","Angry","Joyful","Tired"],d:'easy'},
    {q:'What is the main idea of a paragraph?',a:'The most important point the author makes',c:["A detail that supports the topic","The most important point the author makes","The last sentence only","A list of characters"],d:'easy'},
    {q:'Which sentence uses correct punctuation?',a:'The dog ran fast.',c:["The dog ran fast","The dog ran fast.","the dog ran fast.","The dog ran fast!"],d:'easy'},
    {q:'What is a noun?',a:'A person, place, or thing',c:["An action word","A describing word","A person, place, or thing","A connecting word"],d:'easy'},
    {q:'What does the prefix \'un-\' mean?',a:'Not or opposite of',c:["Again","Before","Not or opposite of","After"],d:'easy'},
    {q:'Which word is an antonym for \'cold\'?',a:'Warm',c:["Icy","Warm","Frozen","Chilly"],d:'easy'},
    {q:'What is a verb?',a:'An action or being word',c:["A naming word","A describing word","An action or being word","A connecting word"],d:'easy'},
    {q:'If a story is fiction, it means:',a:'It is made up',c:["It is all true","It is made up","It has pictures","It has no characters"],d:'easy'},
    {q:'What does the word \'enormous\' mean?',a:'Very large',c:["Very small","Very fast","Very large","Very old"],d:'easy'},
    {q:'Which is an example of a compound word?',a:'Sunlight',c:["Running","Sunlight","Happily","Jumped"],d:'easy'},
    {q:'What is the purpose of a table of contents?',a:'To show where topics are in a book',c:["To list the author's name","To show where topics are in a book","To define hard words","To tell the ending"],d:'easy'},
    {q:'Which word is an adjective?',a:'Fluffy',c:["Run","Quickly","Fluffy","And"],d:'easy'},
    {q:'What does \'compare and contrast\' mean?',a:'Finding how things are alike and different',c:["Telling a story in order","Finding how things are alike and different","Describing one thing only","Listing facts"],d:'easy'},
    {q:'Which is a complete sentence?',a:'The cat sat on the mat.',c:["The big brown","Ran very fast","The cat sat on the mat.","Over the hill"],d:'easy'},
    {q:'What does a glossary do?',a:'Defines important words',c:["Lists chapter titles","Defines important words","Tells who wrote the book","Shows pictures"],d:'easy'},
    {q:'The suffix \'-ful\' means:',a:'Full of',c:["Without","Full of","Again","Before"],d:'medium'},
    {q:'Which sentence is a question?',a:'Where is the library?',c:["Go to the store.","I like ice cream.","Where is the library?","She walked home."],d:'medium'},
    {q:'What is a character in a story?',a:'A person or animal in the story',c:["The place the story happens","The problem in the story","A person or animal in the story","The lesson of the story"],d:'medium'},
    {q:'What does \'predict\' mean when reading?',a:'To guess what will happen next',c:["To summarize what happened","To guess what will happen next","To find the main idea","To describe the setting"],d:'medium'},
    {q:'Which word has a long \'a\' sound?',a:'Rain',c:["Cat","Hat","Rain","Band"],d:'medium'},
    {q:'What is the plot of a story?',a:'The events that happen in the story',c:["Where the story happens","Who the characters are","The events that happen in the story","The lesson learned"],d:'medium'},
    {q:'Which punctuation mark ends an exclamatory sentence?',a:'Exclamation point',c:["Period","Question mark","Comma","Exclamation point"],d:'medium'},
    {q:'What does the word \'ancient\' mean?',a:'Very old',c:["Very new","Very old","Very fast","Very loud"],d:'medium'},
    {q:'Which is a proper noun?',a:'Dallas',c:["city","dog","Dallas","river"],d:'medium'},
    {q:'What does \'context clues\' mean?',a:'Using surrounding words to figure out a word\'s meaning',c:["Looking up words in a dictionary","Using surrounding words to figure out a word's meaning","Sounding out a word","Asking a teacher"],d:'medium'},
    {q:'Which word is a plural noun?',a:'Books',c:["Child","Mouse","Books","Run"],d:'medium'},
    {q:'What is the theme of a story?',a:'The central message or lesson',c:["The setting","The main character's name","The central message or lesson","The beginning of the story"],d:'medium'},
    {q:'Which word means to look at something carefully?',a:'Observe',c:["Glance","Observe","Ignore","Forget"],d:'medium'},
    {q:'What does nonfiction mean?',a:'Writing about real people, places, or events',c:["A made-up story","A story with animals","Writing about real people, places, or events","A poem"],d:'medium'},
    {q:'Which sentence uses a comma correctly?',a:'I like cats, dogs, and fish.',c:["I like cats dogs and fish.","I like, cats dogs and fish.","I like cats, dogs, and fish.","I, like cats dogs and fish."],d:'medium'},
    {q:'What is an adverb?',a:'A word that describes a verb',c:["A naming word","A word that describes a verb","A connecting word","An action word"],d:'medium'},
    {q:'Which word is a homophone for \'write\'?',a:'Right',c:["Right","Wrote","Writing","White"],d:'medium'},
    {q:'What does the word \'curious\' mean?',a:'Eager to know or learn',c:["Bored and tired","Eager to know or learn","Angry and upset","Happy and cheerful"],d:'hard'},
    {q:'What is an author\'s purpose when writing to entertain?',a:'To tell an enjoyable story',c:["To give information about a topic","To convince the reader of something","To tell an enjoyable story","To teach a skill"],d:'hard'},
    {q:'Which word rhymes with \'night\'?',a:'Light',c:["Neat","Note","Light","Knit"],d:'hard'},
    {q:'What does a diagram in a nonfiction book help you do?',a:'Understand something visually',c:["Read faster","Understand something visually","Find the theme","Learn vocabulary"],d:'hard'},
    {q:'Which is an example of alliteration?',a:'Peter picked a peck of pickled peppers.',c:["The cat sat on the mat.","Peter picked a peck of pickled peppers.","The wind blew the leaves.","She ate an apple."],d:'hard'},
    {q:'What does the word \'exhausted\' mean?',a:'Extremely tired',c:["Full of energy","Very hungry","Extremely tired","Quite happy"],d:'hard'},
    {q:'What is a simile?',a:'A comparison using \'like\' or \'as\'',c:["A word that sounds like what it means","A comparison using 'like' or 'as'","An exaggeration","A repeated beginning sound"],d:'hard'},
    {q:'Which sentence is in the past tense?',a:'She ran to school.',c:["She runs to school.","She will run to school.","She ran to school.","She is running to school."],d:'hard'},
    {q:'What is a biography?',a:'A true story about a real person\'s life',c:["A made-up adventure story","A poem about nature","A true story about a real person's life","A how-to book"],d:'hard'},
    {q:'What does the prefix \'re-\' mean?',a:'Again',c:["Before","Again","Not","After"],d:'hard'},
    {q:'Which word best completes: The kitten was as soft as ___.',a:'Cotton',c:["Stone","Thunder","Cotton","Metal"],d:'hard'},
    {q:'What is the resolution of a story?',a:'How the problem gets solved',c:["When the problem begins","The most exciting moment","How the problem gets solved","Who the characters are"],d:'hard'},
    {q:'Which text feature helps find a specific word quickly?',a:'Index',c:["Table of contents","Index","Glossary","Caption"],d:'hard'},
    {q:'What does \'summarize\' mean?',a:'To retell the most important ideas in your own words',c:["To copy the text word for word","To retell the most important ideas in your own words","To predict what will happen","To ask questions about the text"],d:'hard'},
    {q:'Which word is a conjunction?',a:'And',c:["Quickly","Beautiful","And","Leap"],d:'hard'},
    {q:'What does \'transparent\' mean?',a:'Able to be seen through',c:["Very heavy","Able to be seen through","Very colorful","Completely solid"],d:'hard'},
    {q:'Which type of writing gives step-by-step instructions?',a:'Procedural text',c:["Fiction","Poetry","Procedural text","Biography"],d:'hard'},
  ],
  elliot:[
    {q:'Which word is spelled correctly?',a:'friend',c:["frend","freind","friend","freiend"],d:'easy'},
    {q:'Which word is spelled correctly?',a:'believe',c:["beleive","believe","beleeve","belive"],d:'easy'},
    {q:'Which word is spelled correctly?',a:'receive',c:["recieve","receive","receve","receeve"],d:'easy'},
    {q:'Which word is spelled correctly?',a:'necessary',c:["necesary","neccesary","necessary","necessery"],d:'easy'},
    {q:'Which word is spelled correctly?',a:'calendar',c:["calender","callender","calander","calendar"],d:'easy'},
    {q:'Which word is spelled correctly?',a:'forty',c:["fourty","forty","foarty","fortie"],d:'easy'},
    {q:'Which word is spelled correctly?',a:'address',c:["adress","addres","address","adres"],d:'easy'},
    {q:'Which word is spelled correctly?',a:'beginning',c:["begining","beginning","beggining","begginning"],d:'easy'},
    {q:'Which word is spelled correctly?',a:'separate',c:["seperate","separete","separite","separate"],d:'easy'},
    {q:'Which word is spelled correctly?',a:'excitement',c:["exitement","excitment","excitement","excitament"],d:'easy'},
    {q:'Which word is spelled correctly?',a:'grammar',c:["grammer","gramar","gramer","grammar"],d:'easy'},
    {q:'Which word is spelled correctly?',a:'beautiful',c:["beautifull","beautiful","beutiful","beautful"],d:'easy'},
    {q:'Which word is spelled correctly?',a:'different',c:["diffrent","diferent","diffirent","different"],d:'easy'},
    {q:'Which word is spelled correctly?',a:'interesting',c:["intresting","intersting","interesting","intristing"],d:'easy'},
    {q:'Which word is spelled correctly?',a:'library',c:["libary","liberry","library","libery"],d:'easy'},
    {q:'Which word is spelled correctly?',a:'Wednesday',c:["Wednesday","Wendsday","Wednessday","Wendesday"],d:'easy'},
    {q:'Which word is spelled correctly?',a:'dessert',c:["dessert","desirt","dezert","desart"],d:'medium'},
    {q:'Which word is spelled correctly?',a:'strength',c:["strenth","strenngth","strenght","strength"],d:'medium'},
    {q:'Which word is spelled correctly?',a:'rhythm',c:["rythm","rhythem","rhythm","rithm"],d:'medium'},
    {q:'Which word is spelled correctly?',a:'environment',c:["environment","enviroment","envirnment","enviorment"],d:'medium'},
    {q:'Complete: I ___ the ball across the yard.',a:'threw',c:["through","threw","thrue","thru"],d:'medium'},
    {q:'Complete: The wind ___ all night.',a:'blew',c:["blue","blew","bleu","bluw"],d:'medium'},
    {q:'Complete: She ___ her test on Monday.',a:'passed',c:["past","pasted","passed","passt"],d:'medium'},
    {q:'Complete: The dog wagged ___ tail.',a:'their',c:["there","they're","their","thier"],d:'medium'},
    {q:'Complete: We are going ___ the park.',a:'to',c:["too","to","two","tow"],d:'medium'},
    {q:'Complete: I can ___ the music from outside.',a:'hear',c:["here","hear","heer","heear"],d:'medium'},
    {q:'Complete: She ___ a red dress to the party.',a:'wore',c:["where","ware","wear","wore"],d:'medium'},
    {q:'Which sentence uses the correct homophone?',a:'They\'re going to the store.',c:["Their going to the store.","There going to the store.","They're going to the store.","Theyre going to the store."],d:'medium'},
    {q:'Which word means a period of seven days?',a:'week',c:["weak","weack","week","weeke"],d:'medium'},
    {q:'Complete: The ___ shone brightly.',a:'sun',c:["sun","son","sunn","sonne"],d:'medium'},
    {q:'Correct plural of leaf?',a:'leaves',c:["leafs","leaves","leavs","leafes"],d:'medium'},
    {q:'Correct plural of child?',a:'children',c:["childs","childes","childrens","children"],d:'medium'},
    {q:'Correct plural of tooth?',a:'teeth',c:["tooths","teeths","teeth","toothes"],d:'medium'},
    {q:'Correct plural of wolf?',a:'wolves',c:["wolfs","wolfes","wolve","wolves"],d:'hard'},
    {q:'Correct plural of city?',a:'cities',c:["citys","cities","cityes","citeis"],d:'hard'},
    {q:'What does the prefix mis- mean?',a:'Wrongly or badly',c:["Again","Before","Wrongly or badly","Not enough"],d:'hard'},
    {q:'Which word uses pre- to mean made before?',a:'premade',c:["premade","predog","pretree","prerun"],d:'hard'},
    {q:'What does the suffix -less mean?',a:'Without',c:["Full of","Without","The act of","One who"],d:'hard'},
    {q:'What does the suffix -tion do to a word?',a:'Makes it a noun',c:["Makes it an adjective","Makes it a verb","Makes it a noun","Makes it an adverb"],d:'hard'},
    {q:'Which uses the suffix -ful correctly?',a:'hopeful',c:["hopefull","hopeful","hopefl","hopful"],d:'hard'},
    {q:'Which follows i before e except after c?',a:'piece',c:["science","weird","piece","either"],d:'hard'},
    {q:'Adding -ing to run, you must:',a:'Double the n',c:["Drop the n","Add an e","Double the n","Keep it the same"],d:'hard'},
    {q:'Which word has a silent letter?',a:'knight',c:["jump","table","knight","stone"],d:'hard'},
    {q:'Correct spelling of the number 12?',a:'twelve',c:["twelv","tweleve","twelve","twleve"],d:'hard'},
    {q:'Which word has a long e sound spelled ea?',a:'reach',c:["break","great","bread","reach"],d:'hard'},
    {q:'Which word means very happy and excited?',a:'thrilled',c:["gloomy","thrilled","bored","nervous"],d:'hard'},
    {q:'Best synonym for big?',a:'enormous',c:["tiny","enormous","quick","quiet"],d:'hard'},
    {q:'Opposite of ancient?',a:'modern',c:["old","historic","modern","distant"],d:'hard'},
    {q:'Which word means to look at something for a long time?',a:'stare',c:["glance","peek","stare","blink"],d:'hard'},
    {q:'Complete: The scientist made an important ___.',a:'discovery',c:["discovary","discoverery","discovery","discoverie"],d:'hard'},
    {q:'What is 7 x 8?',a:'56',c:["54","56","63","48"],d:'easy'},
    {q:'What is 12 x 9?',a:'108',c:["99","108","98","118"],d:'easy'},
    {q:'What is 6 x 11?',a:'66',c:["66","61","72","67"],d:'easy'},
    {q:'What is 24 x 3?',a:'72',c:["62","70","72","67"],d:'easy'},
    {q:'What is 15 x 4?',a:'60',c:["54","60","65","45"],d:'easy'},
    {q:'What is 23 x 5?',a:'115',c:["105","110","115","120"],d:'easy'},
    {q:'What is 100 x 7?',a:'700',c:["107","700","70","7,000"],d:'easy'},
    {q:'What is 14 x 6?',a:'84',c:["80","84","86","90"],d:'easy'},
    {q:'What is 72 / 9?',a:'8',c:["7","8","9","6"],d:'easy'},
    {q:'What is 144 / 12?',a:'12',c:["11","13","12","14"],d:'easy'},
    {q:'What is 56 / 7?',a:'8',c:["7","8","6","9"],d:'easy'},
    {q:'What is 90 / 6?',a:'15',c:["12","15","14","16"],d:'easy'},
    {q:'What is 132 / 11?',a:'12',c:["11","12","13","14"],d:'easy'},
    {q:'What is 200 / 4?',a:'50',c:["40","50","45","55"],d:'easy'},
    {q:'Which fraction is equivalent to 2/4?',a:'Both 3/6 and 1/2',c:["1/3","3/6","1/2","Both 3/6 and 1/2"],d:'easy'},
    {q:'What is 3/8 + 1/8?',a:'4/8',c:["4/16","4/8","2/8","1/2"],d:'easy'},
    {q:'What is 5/6 - 2/6?',a:'3/6',c:["3/12","3/0","3/6","7/6"],d:'medium'},
    {q:'Which is greater: 3/4 or 2/3?',a:'3/4',c:["2/3","3/4","They are equal","Cannot tell"],d:'medium'},
    {q:'What is 1/4 of 20?',a:'5',c:["4","5","8","10"],d:'medium'},
    {q:'Simplest form of 6/8?',a:'3/4',c:["6/8","3/4","2/3","1/2"],d:'medium'},
    {q:'Which fraction is less than 1/2?',a:'3/8',c:["3/4","5/8","3/8","2/3"],d:'medium'},
    {q:'What is 2 + 1/3 as a mixed number?',a:'2 1/3',c:["3/3","2 1/3","2/3","1 2/3"],d:'medium'},
    {q:'What decimal equals 1/2?',a:'0.5',c:["0.12","0.5","0.2","0.25"],d:'medium'},
    {q:'What decimal equals 1/4?',a:'0.25',c:["0.4","0.14","0.25","0.50"],d:'medium'},
    {q:'Which decimal is greatest?',a:'0.44',c:["0.4","0.04","0.40","0.44"],d:'medium'},
    {q:'What is 0.3 + 0.4?',a:'0.7',c:["0.34","0.12","0.7","7.0"],d:'medium'},
    {q:'What is 1.5 - 0.8?',a:'0.7',c:["0.3","0.7","1.3","0.6"],d:'medium'},
    {q:'Value of digit 5 in 3,527?',a:'500',c:["5","50","500","5,000"],d:'medium'},
    {q:'Round 6,472 to the nearest thousand.',a:'6,000',c:["6,000","6,400","6,500","7,000"],d:'medium'},
    {q:'Round 3,850 to the nearest hundred.',a:'3,900',c:["3,800","3,900","4,000","3,000"],d:'medium'},
    {q:'What is 4,000 + 700 + 30 + 2?',a:'4,732',c:["4,073","4,703","4,732","4,372"],d:'medium'},
    {q:'10,000 more than 45,321?',a:'55,321',c:["46,321","55,321","45,421","54,321"],d:'medium'},
    {q:'What is 3,486 + 2,759?',a:'6,245',c:["5,245","6,145","6,245","6,135"],d:'medium'},
    {q:'What is 8,003 - 4,756?',a:'3,247',c:["3,247","4,253","3,353","4,247"],d:'hard'},
    {q:'How many inches in 2 feet?',a:'24',c:["12","20","24","18"],d:'hard'},
    {q:'How many feet in 1 yard?',a:'3',c:["2","3","4","12"],d:'hard'},
    {q:'How many ounces in 1 pound?',a:'16',c:["8","12","16","100"],d:'hard'},
    {q:'How many centimeters in 1 meter?',a:'100',c:["10","100","1,000","50"],d:'hard'},
    {q:'How many grams in 1 kilogram?',a:'1,000',c:["10","100","1,000","500"],d:'hard'},
    {q:'Table is 150 cm. How many meters?',a:'1.5 m',c:["0.15 m","15 m","1.5 m","1,500 m"],d:'hard'},
    {q:'Area of rectangle 8 cm x 5 cm?',a:'40 sq cm',c:["13 sq cm","26 sq cm","40 sq cm","80 sq cm"],d:'hard'},
    {q:'Perimeter of square with sides 9 cm?',a:'36 cm',c:["18 cm","27 cm","36 cm","81 cm"],d:'hard'},
    {q:'Degrees in a right angle?',a:'90',c:["45","90","180","360"],d:'hard'},
    {q:'Triangle with all equal sides is called?',a:'Equilateral',c:["Isosceles","Scalene","Right","Equilateral"],d:'hard'},
    {q:'What is a line of symmetry?',a:'A line dividing a shape into two identical halves',c:["A line that shows length","A line dividing a shape into two identical halves","A line connecting two points","A diagonal line"],d:'hard'},
    {q:'Rule for pattern: 3, 6, 12, 24, ___?',a:'Multiply by 2',c:["Add 3","Multiply by 3","Multiply by 2","Add 12"],d:'hard'},
    {q:'Missing number: 8 x ___ = 96',a:'12',c:["10","11","12","13"],d:'hard'},
    {q:'If n + 14 = 30, what is n?',a:'16',c:["14","16","18","44"],d:'hard'},
    {q:'Next number: 100, 90, 80, 70, ___?',a:'60',c:["65","60","55","50"],d:'hard'},
    {q:'One bag = 12 apples. 7 bags = how many?',a:'84',c:["74","84","78","82"],d:'hard'},
  ],
  owen:[
    {q:'What is 5/6 / (2/3)?',a:'5/4',c:["10/18","5/4","3/4","10/9"],d:'easy'},
    {q:'Ratio of 8 to 12 in simplest form?',a:'2:3',c:["4:6","8:12","2:3","1:2"],d:'easy'},
    {q:'What is 30% of 150?',a:'45',c:["30","45","50","60"],d:'easy'},
    {q:'Solve: 4x + 3 = 19',a:'x = 4',c:["x = 3","x = 4","x = 5","x = 6"],d:'easy'},
    {q:'Area of triangle: base 10 cm, height 6 cm?',a:'30 sq cm',c:["60 sq cm","16 sq cm","30 sq cm","20 sq cm"],d:'easy'},
    {q:'Absolute value of -15?',a:'15',c:["-15","0","15","1/15"],d:'easy'},
    {q:'What is 2/3 of 90?',a:'60',c:["45","60","30","18"],d:'easy'},
    {q:'Which is NOT an integer?',a:'2.5',c:["-5","0","7","2.5"],d:'easy'},
    {q:'Surface area: rectangular prism 5x3x4?',a:'94 sq units',c:["60 sq units","94 sq units","47 sq units","120 sq units"],d:'easy'},
    {q:'Mean of 12, 16, 20, 24, 28?',a:'20',c:["18","22","20","24"],d:'easy'},
    {q:'Solve: -6 + 10 = ?',a:'4',c:["-4","4","16","-16"],d:'easy'},
    {q:'What is 3.6 x 10 to the power of -2?',a:'0.036',c:["360","0.36","0.036","36"],d:'easy'},
    {q:'Prime factorization of 60?',a:'2 squared x 3 x 5',c:["2 x 30","2 squared x 3 x 5","4 x 15","2 x 3 x 10"],d:'easy'},
    {q:'Volume of cube with side 6 cm?',a:'216 cu cm',c:["36 cu cm","216 cu cm","72 cu cm","108 cu cm"],d:'easy'},
    {q:'If x = -3, what is 2x squared - 5?',a:'13',c:["13","7","-23","23"],d:'easy'},
    {q:'What is a unit rate?',a:'A comparison of two unlike quantities with denominator 1',c:["A rate with denominator of 100","A comparison of two unlike quantities with denominator 1","A rate that stays constant","The average of several rates"],d:'easy'},
    {q:'What is 25% of 180?',a:'45',c:["40","45","50","55"],d:'medium'},
    {q:'Median of: 5, 12, 3, 8, 15, 7?',a:'7.5',c:["7","7.5","8","9"],d:'medium'},
    {q:'Area of parallelogram: base 9 cm, height 4 cm?',a:'36 sq cm',c:["13 sq cm","26 sq cm","36 sq cm","72 sq cm"],d:'medium'},
    {q:'Solve: n/4 = 12',a:'n = 48',c:["n = 3","n = 48","n = 16","n = 8"],d:'medium'},
    {q:'Which value equals 3/4?',a:'0.75',c:["0.34","0.75","0.7","0.43"],d:'medium'},
    {q:'What is -7 x -3?',a:'21',c:["-21","21","10","-10"],d:'medium'},
    {q:'Perimeter of regular octagon with sides 5 cm?',a:'40 cm',c:["35 cm","40 cm","45 cm","30 cm"],d:'medium'},
    {q:'Shirt $40, 15% off. Sale price?',a:'$34',c:["$34","$36","$38","$32"],d:'medium'},
    {q:'Mode of: 4, 7, 4, 9, 7, 4, 3?',a:'4',c:["7","9","4","3"],d:'medium'},
    {q:'What is 4/5 / 8?',a:'1/10',c:["32/5","1/10","5/32","32/40"],d:'medium'},
    {q:'Range of: 3, 15, 7, 22, 10?',a:'19',c:["15","17","19","22"],d:'medium'},
    {q:'Solve: 2(x - 3) = 10',a:'x = 8',c:["x = 4","x = 5","x = 8","x = 6"],d:'medium'},
    {q:'GCF of 24 and 36?',a:'12',c:["6","12","18","8"],d:'medium'},
    {q:'What percent is 18 of 72?',a:'25%',c:["18%","20%","25%","30%"],d:'medium'},
    {q:'LCM of 8 and 12?',a:'24',c:["24","36","48","96"],d:'medium'},
    {q:'What is 5 cubed?',a:'125',c:["15","25","125","625"],d:'medium'},
    {q:'Area of circle radius 7 cm (pi = 3.14)?',a:'153.86 sq cm',c:["43.96 sq cm","153.86 sq cm","44 sq cm","21.98 sq cm"],d:'medium'},
    {q:'Car travels 60 miles in 1.5 hours. Unit rate?',a:'40 mph',c:["40 mph","90 mph","45 mph","30 mph"],d:'hard'},
    {q:'What is the value of 2 to the power of 0?',a:'1',c:["0","2","1","Undefined"],d:'hard'},
    {q:'Which inequality is correct? -8 ___ -3',a:'<',c:[">","=","<","at least"],d:'hard'},
    {q:'Circumference of circle diameter 10 cm (pi = 3.14)?',a:'31.4 cm',c:["15.7 cm","31.4 cm","78.5 cm","62.8 cm"],d:'hard'},
    {q:'Solve for y: 3y - 7 = 14',a:'y = 7',c:["y = 5","y = 7","y = 9","y = 21"],d:'hard'},
    {q:'Map scale 1 in = 25 mi. 4.5 inches = how far?',a:'112.5 miles',c:["100 miles","112.5 miles","125 miles","90 miles"],d:'hard'},
    {q:'0.006 as fraction in simplest form?',a:'3/500',c:["6/1000","3/500","6/100","3/50"],d:'hard'},
    {q:'Which is a rational number?',a:'0.333...',c:["sqrt 2","pi","0.333...","sqrt 5"],d:'hard'},
    {q:'Area of trapezoid: bases 6 and 10, height 4?',a:'32 sq cm',c:["32 sq cm","60 sq cm","16 sq cm","64 sq cm"],d:'hard'},
    {q:'Evaluate: 3 + 4 x 2 - 1',a:'10',c:["13","10","15","11"],d:'hard'},
    {q:'What does a negative exponent mean?',a:'The reciprocal of the base to a positive exponent',c:["A number is subtracted","The reciprocal of the base to a positive exponent","The base is negative","The result is negative"],d:'hard'},
    {q:'Percent increase from 50 to 75?',a:'50%',c:["25%","33%","50%","150%"],d:'hard'},
    {q:'Solve: |x + 3| = 7',a:'x = 4 or x = -10',c:["x = 4 only","x = 4 or x = -10","x = -4 only","x = 10 only"],d:'hard'},
    {q:'What is (3/4) squared?',a:'9/16',c:["6/8","9/16","3/8","9/8"],d:'hard'},
    {q:'3 items for $7.50. Price per item?',a:'$2.50',c:["$2.00","$2.50","$3.00","$1.75"],d:'hard'},
    {q:'Volume of triangular prism: base area 12, height 8?',a:'96 cu cm',c:["20 cu cm","96 cu cm","48 cu cm","192 cu cm"],d:'hard'},
    {q:'Equivalent to 4(2x + 3)?',a:'8x + 12',c:["6x + 3","8x + 12","8x + 3","6x + 12"],d:'hard'},
    {q:'What is textual evidence?',a:'Specific words from the text that support a claim',c:["The author's opinion","Specific words from the text that support a claim","The genre of the text","The setting of the text"],d:'easy'},
    {q:'What does denotation mean?',a:'The exact dictionary definition of a word',c:["The emotional meaning of a word","The exact dictionary definition of a word","The origin of a word","A synonym for a word"],d:'easy'},
    {q:'Which literary element involves struggle between opposing forces?',a:'Conflict',c:["Theme","Setting","Conflict","Tone"],d:'easy'},
    {q:'What does analyze mean when reading?',a:'To examine carefully and explain the parts',c:["To copy the text","To examine carefully and explain the parts","To summarize","To predict"],d:'easy'},
    {q:'What is a flat character?',a:'A character with few traits who does not change',c:["A character with many complex traits","A character who changes significantly","A character with few traits who does not change","A character who is the hero"],d:'easy'},
    {q:'What does figurative language mean?',a:'Language that goes beyond literal meaning to create effect',c:["Language that is completely literal","Language that means exactly what it says","Language using figures and charts","Language that goes beyond literal meaning to create effect"],d:'easy'},
    {q:'What is an allegory?',a:'A story with a deeper symbolic meaning',c:["A type of poem with rhyme","A story with a deeper symbolic meaning","A factual account of events","A speech given by a character"],d:'easy'},
    {q:'Which word means showing excessive pride?',a:'Arrogant',c:["Humble","Arrogant","Timid","Generous"],d:'easy'},
    {q:'What does objective mean in writing?',a:'Based on facts without personal feelings',c:["Based on personal feelings","Based on facts without personal feelings","Written in first person","Full of opinions"],d:'easy'},
    {q:'What is the function of a prologue?',a:'To introduce background information before the story',c:["To end the story","To resolve the conflict","To introduce background information before the story","To summarize the theme"],d:'easy'},
    {q:'Which text structure shows why something happened and its results?',a:'Cause and effect',c:["Compare and contrast","Chronological order","Problem and solution","Cause and effect"],d:'easy'},
    {q:'What does rhetoric mean?',a:'The art of effective speaking or writing to persuade',c:["The study of grammar rules","The art of effective speaking or writing to persuade","A type of poetry","A factual report"],d:'easy'},
    {q:'What does verbal irony mean?',a:'When a speaker says the opposite of what they mean',c:["When events turn out opposite of expected","When the reader knows more than characters","When a speaker says the opposite of what they mean","When a character makes a poor decision"],d:'easy'},
    {q:'What is syntax in writing?',a:'The arrangement of words and phrases to create sentences',c:["The meaning of words","The arrangement of words and phrases to create sentences","The origin of words","The tone of the text"],d:'easy'},
    {q:'What does the Latin root scrib/script mean?',a:'To write',c:["To see","To speak","To write","To hear"],d:'easy'},
    {q:'What is an archetype?',a:'A recurring character type or pattern across literature',c:["An old outdated word","A recurring character type or pattern across literature","A type of conflict","A chapter in a book"],d:'easy'},
    {q:'What does subjectivity mean in writing?',a:'Writing influenced by personal feelings and opinions',c:["Writing based solely on facts","Writing influenced by personal feelings and opinions","Writing that avoids opinions","Writing with no point of view"],d:'medium'},
    {q:'What is diction in literature?',a:'The author\'s word choice',c:["A type of rhyme scheme","The story's structure","The author's word choice","The narrator's personality"],d:'medium'},
    {q:'What does the Greek root graph mean?',a:'To write',c:["To write","To speak","To see","To measure"],d:'medium'},
    {q:'What is a motif in literature?',a:'A recurring element that has symbolic significance',c:["A character's motivation","A recurring element that has symbolic significance","The main conflict","The final lesson"],d:'medium'},
    {q:'What is mood in a story?',a:'The feeling a text creates in the reader',c:["The author's attitude toward the subject","The feeling a text creates in the reader","The character's personality","The pacing of the story"],d:'medium'},
    {q:'Which is an example of a paradox?',a:'This is the beginning of the end.',c:["The sun is bright.","She was clearly confused.","This is the beginning of the end.","He ran quickly to the store."],d:'medium'},
    {q:'What does ambiguity mean in writing?',a:'Being open to more than one interpretation',c:["Extreme clarity of meaning","Having only one possible meaning","Being open to more than one interpretation","Using complex vocabulary"],d:'medium'},
    {q:'What does credible mean?',a:'Trustworthy and believable',c:["Exciting and engaging","Trustworthy and believable","Well-organized","Easy to understand"],d:'medium'},
    {q:'What is an omniscient narrator?',a:'A narrator who knows all characters\' thoughts and feelings',c:["A narrator who only knows their own thoughts","A narrator who knows all characters' thoughts and feelings","A narrator who is also a character","A narrator who refuses to explain events"],d:'medium'},
    {q:'What does nuance mean?',a:'A subtle difference in meaning, tone, or expression',c:["An obvious straightforward meaning","A subtle difference in meaning, tone, or expression","A contradiction in the text","An exaggeration"],d:'medium'},
    {q:'What does the suffix -ism mean?',a:'A system, belief, or practice',c:["One who practices","The act of","A system, belief, or practice","Without"],d:'medium'},
    {q:'What is a dynamic character?',a:'A character who undergoes significant change',c:["A minor character","A character who undergoes significant change","A character who never appears on stage","A character who is always cheerful"],d:'medium'},
    {q:'What is rising action?',a:'The events leading to the climax that build tension',c:["The conclusion of the story","The events leading to the climax that build tension","The introduction of the setting","The resolution of the conflict"],d:'medium'},
    {q:'What does perspective mean in literature?',a:'The viewpoint through which the story is told',c:["The order of events","The setting of the story","The viewpoint through which the story is told","The theme of the story"],d:'medium'},
    {q:'Which sentence uses an appositive correctly?',a:'My friend, Sarah, won the award.',c:["My friend, Sarah, won the award.","My friend Sarah won the award","My friend Sarah, won the award.","My, friend Sarah won the award."],d:'medium'},
    {q:'What is satire?',a:'The use of humor or irony to criticize or expose something',c:["A poem about nature","A fictional biography","The use of humor or irony to criticize or expose something","A tragedy ending in death"],d:'medium'},
    {q:'What does juxtaposition mean?',a:'Placing two contrasting things side by side for effect',c:["Placing two contrasting things side by side for effect","Repeating words for emphasis","An appeal to emotion","A comparison using like or as"],d:'medium'},
    {q:'What does the prefix hyper- mean?',a:'Over or excessive',c:["Under or below","Against","Over or excessive","Before"],d:'hard'},
    {q:'What is stream of consciousness in writing?',a:'A style showing the continuous flow of a character\'s thoughts',c:["A style showing the continuous flow of a character's thoughts","A type of dialogue between characters","A poem with no punctuation","A chapter summarizing past events"],d:'hard'},
    {q:'Which word means to deliberately mislead someone?',a:'Deceive',c:["Inform","Clarify","Deceive","Reveal"],d:'hard'},
    {q:'What is an extended metaphor?',a:'A metaphor that continues throughout a text',c:["A metaphor used only once","A comparison using like or as","A metaphor that continues throughout a text","An exaggerated comparison"],d:'hard'},
    {q:'What does corroborate mean?',a:'To confirm or support with evidence',c:["To disprove a claim","To confirm or support with evidence","To summarize information","To question a source"],d:'hard'},
    {q:'What is exposition in drama?',a:'Background information given at the beginning',c:["The climax scene","Background information given at the beginning","A character's dramatic exit","The final scene"],d:'hard'},
    {q:'What does concise mean in writing?',a:'Clear and brief without unnecessary words',c:["Detailed and lengthy","Clear and brief without unnecessary words","Filled with descriptive language","Written in first person"],d:'hard'},
    {q:'What is anaphora in writing?',a:'Repetition of a word at the start of successive clauses',c:["A comparison using like or as","Repetition of a word at the start of successive clauses","An appeal to authority","A reversal of normal word order"],d:'hard'},
    {q:'What does tenacious mean?',a:'Holding firmly to something; persistent',c:["Easily giving up","Careless and unfocused","Holding firmly to something; persistent","Extremely generous"],d:'hard'},
    {q:'What is a foil character?',a:'A character whose traits contrast with the protagonist\'s',c:["A character who is the main villain","A character whose traits contrast with the protagonist's","A character who appears only once","A character with magical abilities"],d:'hard'},
    {q:'Which is an example of ethos in persuasion?',a:'Establishing credibility and trustworthiness',c:["Sharing an emotional story","Using statistics and data","Establishing credibility and trustworthiness","Using extreme exaggeration"],d:'hard'},
    {q:'What does implicit mean?',a:'Suggested or understood without being directly stated',c:["Clearly and directly stated","Suggested or understood without being directly stated","Written in a formal style","Based on personal experience"],d:'hard'},
    {q:'What is a soliloquy in a play?',a:'A speech spoken aloud to oneself revealing thoughts to the audience',c:["A conversation between two characters","A speech spoken aloud to oneself revealing thoughts to the audience","A scene with multiple characters","The final speech of a play"],d:'hard'},
    {q:'What does ephemeral mean?',a:'Lasting for a very short time',c:["Permanent and lasting","Extremely large","Lasting for a very short time","Very old"],d:'hard'},
    {q:'What is symbolism in literature?',a:'When a word or object represents something beyond its literal meaning',c:["Using numbers to represent ideas","When a word or object represents something beyond its literal meaning","A type of rhyme scheme","The story's moral lesson"],d:'hard'},
    {q:'What does proliferate mean?',a:'To grow or multiply rapidly',c:["To decrease rapidly","To grow or multiply rapidly","To study carefully","To organize neatly"],d:'hard'},
    {q:'What is characterization?',a:'The methods used to reveal a character\'s personality',c:["The setting of the story","The theme of the story","The methods used to reveal a character's personality","The plot structure"],d:'hard'},
  ],
};
